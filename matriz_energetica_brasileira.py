...
"""
file = open('/content/drive/MyDrive/..Python Codes/Projeto Dashboard Matriz Energética/teste.tex', 'w')
file.write(teste)
file.close()

file = open('/content/drive/MyDrive/..Python Codes/Projeto Dashboard Matriz Energética/teste.txt', 'w')
file.write(teste)
file.close()

# Transforma o .tex em pdf

########## transforma .tex em string value
pdfl = PDFLaTeX.from_texfile('/content/drive/MyDrive/..Python Codes/Projeto Dashboard Matriz Energética/teste.tex')
pdf, log, completed_process = pdfl.create_pdf(keep_pdf_file = True, keep_log_file = True)

########## transforma string value em pdf
import base64, os
code = pdf
with open(os.path.expanduser('/content/drive/MyDrive/..Python Codes/Projeto Dashboard Matriz Energética/teste2.pdf'), 'wb') as fout:
...
images = convert_from_path("/content/drive/MyDrive/..Python Codes/Projeto Dashboard Matriz Energética/teste.pdf")
